...
const EVENT_PROMPT = `You write event descriptions for The Sea Star. ${SEA_STAR_VOICE}
...
export async function POST(request: NextRequest) {
  ...
  try {
    const content = await generateWithGroq(EVENT_PROMPT, raw_input, { maxTokens: 1000 })
