  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <p className="text-sm text-sea-blue font-dm">{files.length} files</p>
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <select value={bucket} onChange={(e) => setBucket(e.target.value)} className="flex-1 sm:flex-none px-3 py-2.5 bg-[rgba(26,34,54,0.5)] border border-sea-gold/15 text-sea-light font-dm text-xs outline-none min-h-[44px]">
            <option value="Drink Images">Drink Images</option>
            <option value="blog-images">Blog Images</option>
          </select>
          <label className="flex-1 sm:flex-none px-4 py-2.5 bg-sea-gold text-[#06080d] font-dm text-xs font-medium tracking-[0.2em] uppercase hover:bg-sea-gold-light transition-all cursor-pointer text-center min-h-[44px] flex items-center justify-center">
