  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-sm text-sea-blue font-dm mt-2">Configure social media auto-posting and site settings.</p>
      </div>

      {/* Status Banner */}
      <div className={`mb-8 p-4 rounded-lg border ${isConfigured ? 'bg-green-900/10 border-green-500/20' : 'bg-amber-900/10 border-amber-500/20'}`}>
      ...
      {/* Setup Guide */}
      {!isConfigured && (
        <div className="mb-8 p-5 bg-[#0a0e18] border border-sea-gold/10 rounded-lg">
